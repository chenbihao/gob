import{_ as s,c as n,o as e,b as a}from"./app-ByXEg4v2.js";const i={},l=a(`<h1 id="版本" tabindex="-1"><a class="header-anchor" href="#版本"><span>版本</span></a></h1><h2 id="命令" tabindex="-1"><a class="header-anchor" href="#命令"><span>命令</span></a></h2><p>相关的命令详见：<a href="../command/version">version</a></p><p>gob 提供了查询当前版本和获取最新版本日志的命令</p><h2 id="查询当前版本" tabindex="-1"><a class="header-anchor" href="#查询当前版本"><span>查询当前版本</span></a></h2><p>使用命令 <code>gob version</code></p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line">&gt; ./gob version</span>
