import{_ as n,c as s,o as e,b as a}from"./app-CiuEt72j.js";const i={},l=a(`<h1 id="辅助函数" tabindex="-1"><a class="header-anchor" href="#辅助函数"><span>辅助函数</span></a></h1><p>提供一些辅助函数来帮助更好的进行开发。</p><h2 id="goroutine-相关" tabindex="-1"><a class="header-anchor" href="#goroutine-相关"><span>goroutine 相关</span></a></h2><h3 id="safego" tabindex="-1"><a class="header-anchor" href="#safego"><span>SafeGo</span></a></h3><p>SafeGo 这个函数，提供了一种goroutine安全的函数调用方式。主要适用于业务中需要进行开启异步goroutine业务逻辑调用的场景。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">// SafeGo 进行安全的goroutine调用</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>调用方式参照如下的单元测试用例：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line"></span>
...
<span class="line"></span>
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="safegoandwait" tabindex="-1"><a class="header-anchor" href="#safegoandwait"><span>SafeGoAndWait</span></a></h3><p>SafeGoAndWait 这个函数，提供安全的多并发调用方式。该函数等待所有函数都结束后才返回。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">// SafeGoAndWait 进行并发安全并行调用</span>
<span class="line">// 第一个参数是context接口，如果还实现了Container接口，且绑定了日志服务，则使用日志服务</span>
