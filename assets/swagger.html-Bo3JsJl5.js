import{_ as s,c as n,o as a,b as e}from"./app-3nXj21aS.js";const l={},i=e(`<h1 id="swagger" tabindex="-1"><a class="header-anchor" href="#swagger"><span>swagger</span></a></h1><h2 id="命令" tabindex="-1"><a class="header-anchor" href="#命令"><span>命令</span></a></h2><p>相关的命令详见：<a href="../command/swagger">swagger</a></p><p>gob 使用 <a href="https://github.com/swaggo/swag" target="_blank" rel="noopener noreferrer">swaggo</a> 集成了 swagger 生成和服务项目。</p><p>并且封装了 <code>./gob swagger</code> 命令。</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="line"><span class="token operator">&gt;</span> ./gob swagger</span>
