import{_ as n,c as s,o as e,b as a}from"./app-CiuEt72j.js";const i={},l=a(`<h1 id="版本" tabindex="-1"><a class="header-anchor" href="#版本"><span>版本</span></a></h1><h2 id="命令" tabindex="-1"><a class="header-anchor" href="#命令"><span>命令</span></a></h2><p>相关的命令详见：<a href="../command/version">version</a></p><p>gob 提供了查询当前版本和获取最新版本日志的命令</p><h2 id="查询当前版本" tabindex="-1"><a class="header-anchor" href="#查询当前版本"><span>查询当前版本</span></a></h2><p>使用命令 <code>gob version</code></p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">&gt; ./gob version</span>
<span class="line">gob version: 1.0.0</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="获取最新的版本" tabindex="-1"><a class="header-anchor" href="#获取最新的版本"><span>获取最新的版本</span></a></h2><p>使用命令 <code>gob version list</code></p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">&gt; ./gob version list       </span>
