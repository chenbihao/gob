import{_ as s,c as n,o as e,b as a}from"./app-BSoEOH6w.js";const i={},l=a(`<h1 id="目录结构" tabindex="-1"><a class="header-anchor" href="#目录结构"><span>目录结构</span></a></h1><p>gob 框架不仅仅是一个类库，也是一个定义了开发模式和目录结构的框架。</p><p>gob 希望所有使用这个框架的开发人员遵照统一的项目结构进行开发。</p><h2 id="默认目录结构" tabindex="-1"><a class="header-anchor" href="#默认目录结构"><span>默认目录结构</span></a></h2><p>默认创建的项目结构为：</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token operator">&gt;</span> tree</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里主要介绍下业务模块的分层结构</p><h1 id="业务模块分层" tabindex="-1"><a class="header-anchor" href="#业务模块分层"><span>业务模块分层</span></a></h1><p>业务模块的分层设计两种分层模型：简化模型和标准模型。基本稍微复杂一些的业务，都需要使用标准模型开发。</p><h2 id="简化模型" tabindex="-1"><a class="header-anchor" href="#简化模型"><span>简化模型</span></a></h2><p>对于比较简单的业务，每个模块各自定义自己的 model 和 service，在一个 module 文件的文件夹中进行各自模块的业务开发</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">├── api.go      // 业务模块接口</span>
<span class="line">├── dto.go      // 业务模块输出结构</span>
<span class="line">├── mapper.go   // 将服务结构转换为业务模块输出结构</span>
<span class="line">├── model.go    // 数据库结构定义</span>
<span class="line">├── repository.go   // 数据库逻辑封装层</span>
<span class="line">└── service.go  // 服务</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>具体实现可以参考初始化代码的 Demo 接口实现</p><h2 id="标准模型" tabindex="-1"><a class="header-anchor" href="#标准模型"><span>标准模型</span></a></h2><p>对于比较复杂的业务，模块与模块间的交互比较复杂，有很多公用性，所以提取 service provider 服务作为服务间的相互调用。</p><p>强烈建议使用这种开发模型</p><p>第一步：创建当前业务的 provider。可以使用命令行 <code>./gob provider new</code> 来创建。</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token operator">&gt;</span> ./gob provider new</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>定义好 provider 的协议</p><div class="language-golang line-numbers-mode" data-highlighter="prismjs" data-ext="golang" data-title="golang"><pre><code><span class="line">package demo</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>具体实现可以参考初始化代码的 Demo2 接口实现</p>`,28),d=[l];function p(c,r){return e(),n("div",null,d)}const t=s(i,[["render",p],["__file","structure.html.vue"]]),m=JSON.parse('{"path":"/guide/structure.html","title":"目录结构","lang":"zh-CN","frontmatter":{"lang":"zh-CN","title":"目录结构","description":null},"headers":[{"level":2,"title":"默认目录结构","slug":"默认目录结构","link":"#默认目录结构","children":[]},{"level":2,"title":"简化模型","slug":"简化模型","link":"#简化模型","children":[]},{"level":2,"title":"标准模型","slug":"标准模型","link":"#标准模型","children":[]}],"git":{"updatedTime":1718016868000,"contributors":[{"name":"被水淹没","email":"994523036@qq.com","commits":1},{"name":"陈壁浩","email":"chenbihao@qljy.com","commits":1}]},"filePathRelative":"guide/structure.md"}');export{t as comp,m as data};
