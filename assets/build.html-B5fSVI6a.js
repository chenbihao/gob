import{_ as n,c as e,o as l,b as a}from"./app-BSoEOH6w.js";const s={},i=a(`<h1 id="编译" tabindex="-1"><a class="header-anchor" href="#编译"><span>编译</span></a></h1><h2 id="命令" tabindex="-1"><a class="header-anchor" href="#命令"><span>命令</span></a></h2><p>应用分为前端（frontend）和后端（backend），所以编译也分为三类</p><ul><li>编译前端</li><li>编译后端</li><li>自编译</li><li>同时编译</li></ul><p>相关的命令详见：<a href="../command/build">build</a></p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">&gt; ./gob build</span>
