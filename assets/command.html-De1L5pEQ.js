import{_ as e,r as l,c as i,a as n,d as s,e as c,w as t,b as d,o}from"./app-ByXEg4v2.js";const p={},r=n("h1",{id:"命令",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#命令"},[n("span",null,"命令")])],-1),m=n("h2",{id:"指南",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#指南"},[n("span",null,"指南")])],-1),u=d(`<p>gob 允许自定义命令，挂载到 gob 上。并且提供了<code>./gob command</code> 系列命令。</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="line"><span class="token operator">&gt;</span> ./gob <span class="token builtin class-name">command</span></span>
