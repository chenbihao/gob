...
/*
 * collection库 一个让业务开发效率提高10倍的golang库
 * Collection包目标是用于替换golang原生的Slice，使用场景是在大量不追求极致性能，追求业务开发效能的场景。
 *
 * source: https://github.com/jianfengye/collection/releases/tag/v2.0.5
 * docs:  http://collection.funaio.cn/
 */

/*
 * Copyright [jianfengye110]
